...
<section id="hero-area" class="hero-area">
    ...
    <div class="slider-area">
        <?php
                ...
                ?>
        <!-- Single Slider -->
        <div class="single-slider <?php echo !empty($classItemSlide)?$classItemSlide:false; ?>"
            style="background-image:url('<?php echo _WEB_HOST_TEMPLATE; ?>/images/slider/slider-image1.jpg')">
            <div class="container">
                <div class="row">
                    <?php
                            $allowTwoCol = false;
                    ...
                    <div class="<?php echo $classCol; ?>">
                        ...
                        <div class="slider-text">
                            ...
                            <div class="button">
                                ...
                                <a href="<?php echo $item['slide_button_link']; ?>"
                                    class="btn"><?php echo (!empty($item['slide_button_text']))?$item['slide_button_text']:'Xem thêm'; ?></a>
                                <?php endif; ?>
                                <?php if (!empty($item['slide_video'])): ?>
                                <a href="<?php echo $item['slide_video']; ?>" class="btn video video-popup mfp-fade"><i
