...
$listAllBlog = getRaw("SELECT blog.*,name FROM blog INNER JOIN blog_categories ON blog_categories.id=blog.category_id WHERE category_id=$id LIMIT $offset, $perPage");
?>
<!-- Blogs Area -->
