...
if (isPost()) {
    ...
    redirect('?module=blog&action=edit&id=' . $blogId);
}
    ...
    <div class="container-fluid">
        ...
        <form action="" method="post">
            <div class="form-group">
                ...
                <input type="text" class="form-control slug" name="title" placeholder="Tiêu đề blog...." value="<?php echo oldData('title', $old) ?>">
            ...
            <div class="form-group">
                ...
                <textarea name="description" class="form-control" placeholder="Mô tả blog..."><?php echo oldData('description', $old) ?></textarea>
            ...
            <div class="form-group">
                ...
                <div class="row ckfinder-group">
                    <div class="col-10">
                        <input type="text" class="form-control image-render" name="thumbnail" placeholder="Đường dẫn ảnh...." value="<?php echo oldData('thumbnail', $old) ?>">
                    </div>
                    <div class="col-2">
            ...
            <div class="form-group">
                ...
                <select name="category_id" class="form-control">
                    ...
                    ?>
                            <option value="<?php echo $item['id'] ?>" <?php echo (oldData('category_id', $old) == $item['id']) ? 'selected' : false ?>>
